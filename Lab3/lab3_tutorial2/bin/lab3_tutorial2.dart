...
/* 
  ...
  print(getMultipleArgument("Pankil", "Doshi"));
...
/*  
  ...
  print(getFullName("Pankil", "Doshi"));
  print(getFullName("Pankil", "Doshi", "Hello User"));
...
/* 
  ...
  print(getFullName("Pankil", "Doshi"));
  print(getFullName("Pankil", "Doshi", "Hi,"));
...
/*  
  ...
  print(greetingsNamed(name: "Pankil"));
  ...
  print(greetingsNamedRequired(name: "Pankil"));
...
/* 
  ...
  /// It will take Pankil as argument and name variable will consider as String variables.
