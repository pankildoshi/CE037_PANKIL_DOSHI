...
class UserV5 {
  ...
  UserV5({this.id = 0, this.name = "Doshi"});
...
class UserV6 {
  ...
  UserV6({int id = 0, String name = "Doshi"})
      : _id = id,
        _name = name;
...
void main() {
  ...
  */
  ...
  /*
    ...
    // Long-form constructor
    var user1 = UserV1(1, "Pankil"); // Two arguments are compulsory
    print(user1.id);
    print(user1.name);

    // Short-form constructor
    var user2 = UserV2(2, "Pankil Doshi");
    print(user2.id);
    print(user2.name);
